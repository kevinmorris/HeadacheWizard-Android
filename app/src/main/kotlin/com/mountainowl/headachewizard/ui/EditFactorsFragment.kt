...
class EditFactorsFragment : ListFragment() {
    ...
    private var adapter: EditFactorsAdapter? = null
    ...
    private inner class EditFactorsAdapter(factors: List<Factor>) : ArrayAdapter<Factor>(activity, android.R.layout.simple_list_item_1, factors) {
        ...
        override fun getView(position: Int, view: View?, parent: ViewGroup): View {
            ...
            if (view == null) {
                view = activity.layoutInflater.inflate(R.layout.list_item_edit_factor, null)
            }

            val factorNameField = view!!.findViewById(R.id.factor_name) as TextView
            factorNameField.text = getItem(position).name

            val deleteFactorButton = view.findViewById(R.id.delete_factor_button) as Button
